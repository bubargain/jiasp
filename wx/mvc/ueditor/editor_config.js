...
(function () {
	...
	URL = '/services/weixin/mvc/ueditor/';
	IMG_URL = 'http://mp1.yokacdn.com';
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:IMG_URL                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ,compressSide:1                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        ,maxImageSideLength:480                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        ,imageManagerPath:IMG_URL                                    //图片修正地址，同imagePath
        ...
        ,toolbars:[["fullscreen","source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","searchreplace","insertimage","date","time","anchor","spechars","bold","italic","underline","justifyleft","justifycenter","justifyright","justifyjustify","indent","autotypeset","pasteplain","paragraph","rowspacingbottom","rowspacingtop","lineheight","imagenone","imageleft","imageright","imagecenter"]]
